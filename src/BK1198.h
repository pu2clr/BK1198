...
/**
 * UNDER CONSTRUCTION... 
 * @mainpage PU2CLR BK1198 Arduino Library 
 * @brief PU2CLR BK1198 Arduino Library implementation. <br> 
 ...
 * @details This library is based on BEKEN - BK1198 - BROADCAST AM/FM/SW/LW RADIO RECEIVER manual. 
 * 
 * @see https://github.com/pu2clr/BK1198
 * 
 ...
 * @brief   BK1198 Defined Data Types 
 * @details Defined Data Types is a way to represent the BK1198 registers information
 ...
 * @details BK1198 stereo FM digital tuning radio documentation.
 ...
 * @see  BEKEN - BK1198 - BROADCAST AM/FM/SW/LW RADIO RECEIVER; pages 13 and 14 
 */
typedef union
{
    struct
 ...
 * @see BEKEN - BK1198 - BROADCAST AM/FM/SW/LW RADIO RECEIVER; page 14 
 */
typedef union
{
    struct
