/**
 * UNDER CONSTRUCTION... 
 * @mainpage BK1198 Arduino Library implementation
 * @details BK1198 Arduino Library implementation. This is an Arduino library for the BK1198, BROADCAST RECEIVER.
 * @details This is an Arduino library for the BK1086 and BK1198 DSP BROADCAST RECEIVER.<br>
 * @details It works with I2C protocol and can provide an easier interface for controlling the BK1198 devices.<br>
 * @details This library is based on the Document: BEKEN - BK1198 - BROADCAST AM/FM/SW/LW RADIO RECEIVER Rev 1.3.
 *
...
#include <BK1198.h>
#include <Wire.h> // This library is not used to communicate wwith BK1198 family device. It is used to check I2C bus.

/**
 * @defgroup GA02 BEKEN I2C BUS
 * @section GA02 I2C
 *
 * @brief About I2C Address on BK1198 and Arduino platform
 *
 * The BK1198 Datasheet says that the I2C buss address is 0x80. However, the Wire (I2C) Arduino library does not find
 ...
 * @param i2c_addr
 */
void BK1198::setI2C(uint8_t i2c_addr)
{
 ...
 * @details Configures the I2C bus for BK1198
 *
 * @param pin_sdio SDA/SDIO MCU/Arduino pin
 * @param pin_sclk CLK/SCLK MCU/Arduino pin
 */
void BK1198::i2cInit(int pin_sdio, int pin_sclk)
{
 ...
 */
void BK1198::i2cBeginTransaction()
{
 ...
 */
void BK1198::i2cWriteByte(uint8_t data)
{
    pinMode(pin_sdio, OUTPUT);
    delayMicroseconds(1);
...
/**
 * @ingroup GA02
 * @brief Sends an array of values to a BK1198 given register
 * @param reg register to be written
 * @param value content to be stored into the register
 */
void BK1198::writeRegister(uint8_t reg, uint16_t value)
{
...
/**
 * @ingroup GA02
 * @brief Gets an array of values from a BK1198 given register
 * @param reg register to be read
 * @return register content
 */
uint16_t BK1198::readRegister(uint8_t reg)
{
 ...
 */
uint16_t BK1198::getRegister(uint8_t reg)
{
 ...
 * @details The registers from 0x2 to 0x07 are used to setup the device. This method writes the array  shadowRegisters, elements 8 to 14 (corresponding the registers 0x2 to 0x7 respectively)  into the device. See Device registers map  in BK1198.h file.
 ...
 * @param device register address
 */
void BK1198::setRegister(uint8_t reg, uint16_t value)
{
 ...
 *
 * @see getRSSI
 * @see BK1198E - BROADCAST AM/FM/SW/LW RADIO RECEIVER Rev 1.3; page 17.
 *
 * @return  bk_reg0a data type status register (Register 0Ah. Status2)
 */
bk_reg0a BK1198::getStatus()
{
    bk_reg0a tmp;
 ...
 * @details The STC bit being cleared indicates that the TUNE or SEEK bits may be set again to start another tune or seek operation. Do not set the TUNE or SEEK bits until the BK1198 clears the STC bit.
 */
void BK1198::waitAndFinishTune()
{
 ...
 * @see BEKEN - BK1198 - BROADCAST AM/FM/SW/LW RADIO RECEIVER Rev 1.3; pages 12-21
 * @see setup
 */
void BK1198::powerUp()
{
 ...
 */
void BK1198::setup(int sda_pin, int sclk_pin, uint8_t oscillator_type, uint32_t oscillator_frequency)
{
 ...
 */
void BK1198::setFM(uint16_t minimum_frequency, uint16_t maximum_frequency, uint16_t default_frequency, uint16_t step)
{
 ...
 */
void BK1198::setAM(uint16_t minimum_frequency, uint16_t maximum_frequency, uint16_t default_frequency, uint16_t step, uint16_t am_space)
{
    this->currentStep = step;
    this->currentFrequency = default_frequency;
    this->minimumFrequency = minimum_frequency;
 ...
 * @param channel
 */
void BK1198::setChannel(uint16_t channel)
{
 ...
 * @param frequency
 */
void BK1198::setFrequency(uint16_t frequency)
{
    uint16_t channel;
 ...
 * @return uint16_t
 */
uint16_t BK1198::getRealChannel()
{
    getRegister(REG0B);
 ...
 * @return uint16_t
 */
uint16_t BK1198::getRealFrequency()
{
 ...
 */
void BK1198::seekSoftware(uint8_t seek_mode, uint8_t direction, void (*showFunc)())
{
 ...
 * @param direction  Seek Direction; 0 = Seek down (default); 1 = Seek up.
 */
void BK1198::seekHardware(uint8_t seek_mode, uint8_t direction, void (*showFunc)())
{
 ...
 */
void BK1198::setSeekThreshold(uint8_t rssiValue, uint8_t snrValue)
{
 ...
 *
 * @see BK1198E - BROADCAST AM/FM/SW/LW RADIO RECEIVER Rev 1.3; page 15
 * @param band  the valid values are 0, 1, 2 and 3. See table above.
 */

void BK1198::setBand(uint8_t band)
{
 ...
 */
void BK1198::setSpace(uint8_t space)
{
    if (this->currentMode == BK_MODE_AM)
 ...
 */
void BK1198::setSoftMute(bool value)
{
 ...
 */
void BK1198::setSoftMuteAttack(uint8_t value)
{
 ...
 * @param value See table above
 */
void BK1198::setSoftMuteAttenuation(uint8_t value)
{
 ...
 *
 * @see BK1198 - BROADCAST AM/FM/SW/LW RADIO RECEIVER Rev 1.3; page 19; Register 0x14 (Boot Configuration5)
 * @param rssi  The Mute Threshold Based on RSSI (default 26)
 * @param snr   The Mute Threshold Based on SNR  (default 5)
 */
void BK1198::setMuteThreshold(uint8_t rssi, uint8_t snr)
{
 ...
 */
void BK1198::setSeekMute(bool value)
{
 ...
 */
void BK1198::setAfcMute(bool value)
{
 ...
 */
void BK1198::setAudioMute(bool left, bool right)
{
 ...
 */
void BK1198::setAudioMute(bool value)
{
 ...
 * @param value TRUE or FALSE
 */
void BK1198::setMono(bool value)
{
 ...
 */
void BK1198::setVolume(uint8_t value)
{
    if (value > 31)
        return;
 ...
 * @details There is no information about it in the BK1198 documentation.
 * @param rds_mode  0 = Standard (default); 1 = Verbose
 */
void BK1198::setRdsMode(uint8_t rds_mode)
{
 ...
 */
void BK1198::setRds(bool value, bool interrupt_enable)
{
 ...
 */
uint8_t BK1198::getRdsFlagAB(void)
{
    bk_rds_blockb blkb;
 ...
 * @return uint16_t
 */
uint16_t BK1198::getRdsGroupType()
{
    bk_rds_blockb b;
    b.blockB = reg0d->raw;
 ...
 * @returns  0=A or 1=B
 */
uint8_t BK1198::getRdsVersionCode(void)
{
    bk_rds_blockb b;
    b.blockB = reg0d->raw;
 ...
 */
uint8_t BK1198::getRdsProgramType(void)
{
    bk_rds_blockb b;
    b.blockB = reg0d->raw;
 ...
 * @details It appears that the BK1198 device is typically pre-configured with RBDS setup instead of RDS by default. 
 ...
 */
void inline BK1198::getNext2Block(char *c)
{
 ...
 */
void inline BK1198::getNext4Block(char *c)
{
 ...
 */
bool BK1198::getRdsAllData(char **stationName, char **stationInformation, char **programInformation, char **utcTime)
{
 ...
 * @details For some reason, the BK1198 device does not work with the standard Wire.h library of Arduino. 
 * @details The checkI2C function is only used to test the circuit. 
 * @details In practice, no function from the Wire.h library is utilized in a real application with the BK1198 in this project. 
 ...
 */
int BK1198::checkI2C(uint8_t *addressArray)
{
    Wire.begin();
    int error, address;
    int idx = 0;
 ...
 */
uint16_t *BK1198::getRegisterValues() {
 ...
 */
void BK1198::convertToChar(uint16_t value, char *strValue, uint8_t len, uint8_t dot, uint8_t separator, bool remove_leading_zeros)
{
    char d;
